		...
		<div class="container">
			<div class="faq__inner">
				...
				if ( $faq_title && $heading_tag ) :
					echo '<' . wp_kses_post( $heading_tag ) . ' class="heading-2 faq__heading">' . wp_kses_post( $faq_title ) . '</' . wp_kses_post( $heading_tag ) . '>';
				endif;
				?>
				<div class="faq__list">
					<?php
						...
						<div class="faq__item accordion" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
							...
							if ( $answer ) :
								...
								<div class="faq__item-content accordion__content" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
									<span class="text-medium" itemprop="text"><?php echo wp_kses_post( $answer ); ?></span>
								</div>
								<?php
							endif;
							?>
